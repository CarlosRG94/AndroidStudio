...
public class AdaptadorPersona extends RecyclerView.Adapter<AdaptadorPersona.HolderPersona>
{
    ...
    public AdaptadorPersona(Context contexto, ArrayList<Persona> elementos)
    {
    ...
    {
        personadeturno.tDNI.setText(elementos.get(position).getDNI());
        personadeturno.tNombre.setText(elementos.get(position).getNombre() + " " + elementos.get(position).getApellidos());
        personadeturno.tTelefono.setText(elementos.get(position).getTelefono());
        personadeturno.tEmail.setText(elementos.get(position).getEmail());
    }
